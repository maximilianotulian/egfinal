<div class="us us--baner banner--container">

    <?php $backgroundName="background2"; ?>
    <div class="banner banner" style="background-image: url(<?php echo '/sources/photos/'.$backgroundName.'.jpg'; ?>);" >
    ...
    <div class="section no-padding">
        <div class="row no-padding">
            ...
            <div class="col s12 tecnologies">
                ...
                <div class="row">
                    <h4 class="center">Tecnologías utilizadas</h4><hr />
                    <div class="row">
