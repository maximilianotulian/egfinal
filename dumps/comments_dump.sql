...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_comments_2` FOREIGN KEY (`id_new`) REFERENCES `news` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `permissions` VALUES (1,'ADMIN_ACCESS'),(2,'LIST_NEWS'),(3,'EDIT_NEWS'),(4,'DELETE_NEWS'),(5,'ADD_NEWS'),(6,'SEE_ALL_NEWS'),(7,'EDIT_USERS');
...
INSERT INTO `role_permission` VALUES (1,1),(2,1),(1,2),(2,2),(1,3),(2,3),(1,4),(2,4),(1,5),(2,5),(1,6),(1,7);
...
-- Dump completed on 2016-05-15 19:57:13
